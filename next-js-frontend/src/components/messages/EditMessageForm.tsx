...
export const EditMessageForm = ({prevContentValue,messageId,setEditMessageId,setOpenContextMenuMessageId}:PropTypes) => {
  ...
  const {handleEditMessageSubmit} = useHandleEditMessageSubmit({messageId,setEditMessageId,setOpenContextMenuMessageId,updatedContentValue})
  ...
  return (
    <motion.form initial={{x:3}} animate={{x:0}} onSubmit={handleEditMessageSubmit} className="flex items-center gap-y-3 flex-col ">
