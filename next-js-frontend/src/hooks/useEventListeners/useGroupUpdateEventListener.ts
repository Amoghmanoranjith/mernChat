...
import { selectSelectedChatDetails, updateChatNameOrAvatar } from "@/services/redux/slices/chatSlice"
...
export const useGroupUpdateEventListener = () => {
    ...
    useSocketEvent(Event.GROUP_UPDATE,({_id,name,avatar}:{_id:string,name?:string,avatar?:string})=>{
